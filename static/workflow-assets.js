(() => {
    ...
    // Keep assets directly below Node Mappings. Preflight is inserted after the
    // same mapping section earlier in the script load order, so inserting here
    // places assets between mappings and preflight.
